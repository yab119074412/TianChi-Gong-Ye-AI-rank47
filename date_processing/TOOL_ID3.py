...
train_data=pd.read_csv('C:/Users/user/Desktop/testB_tool_data/TOOL_ID3.csv')
# for i in range(train_data['210X24'].shape[0]):
#     if train_data['210X24'][i]==2.01666166617e+13:
#        train_data['210X24'][i]=np.NaN
train_data_date1=train_data[['300X2', '300X3', '300X4', '300X6', '300X7', '300X9', '300X10', '300X13', '300X14', '300X20']]
...
delta_time=pd.DataFrame(delta_time,columns=['time_delta_2'])
df=pd.concat([max_date,min_date,delta_time],axis=1)
df.to_csv('C:/Users/user/Desktop/testB_deal_date/tool_time_delta_2.csv',index=False)
