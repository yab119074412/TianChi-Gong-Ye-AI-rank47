...
train_data=pd.read_csv('C:/Users/user/Desktop/testB_tool_data/Tool2.csv')
# for i in range(train_data['210X24'].shape[0]):
#     if train_data['210X24'][i]==2.01666166617e+13:
#        train_data['210X24'][i]=np.NaN
train_data_date1=train_data[['220X67', '220X71', '220X75', '220X79', '220X83', '220X87', '220X91', '220X95']]
...
delta_time=pd.DataFrame(delta_time,columns=['time_delta_1'])
df=pd.concat([max_date,min_date,delta_time],axis=1)
df.to_csv('C:/Users/user/Desktop/testB_deal_date/tool_time_delta_1.csv',index=False)
