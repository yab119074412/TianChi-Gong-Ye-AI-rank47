...
train_data=pd.read_csv('C:/Users/user/Desktop/testB_tool_data/TOOL1.csv')
# for i in range(train_data['210X24'].shape[0]):
#     if train_data['210X24'][i]==2.01666166617e+13:
#        train_data['210X24'][i]=np.NaN
train_data_date1=train_data[['210X24', '210X204', '210X205', '210X213', '210X215']]
...
delta_time=pd.DataFrame(delta_time,columns=['time_delta_0'])
df=pd.concat([max_date,min_date,delta_time],axis=1)
df.to_csv('C:/Users/user/Desktop/testB_deal_date/tool_time_delta_0.csv',index=False)
