...
train_data=pd.read_csv('C:/Users/user/Desktop/testB_tool_data/Tool (#1)4.csv')
# for i in range(train_data['210X24'].shape[0]):
#     if train_data['210X24'][i]==2.01666166617e+13:
#        train_data['210X24'][i]=np.NaN
train_data_date1=train_data[[ '310X56', '310X60', '310X64', '310X68', '310X72', '310X76', '310X80', '310X84','311X6', '311X7', '311X20', '311X22',
...
delta_time=pd.DataFrame(delta_time,columns=['time_delta_3'])
df=pd.concat([max_date,min_date,delta_time],axis=1)
df.to_csv('C:/Users/user/Desktop/testB_deal_date/tool_time_delta_3.csv',index=False)
