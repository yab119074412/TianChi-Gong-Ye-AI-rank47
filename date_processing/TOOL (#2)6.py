...
train_data=pd.read_csv('C:/Users/user/Desktop/tool_testA_data/TOOL (#2)6.csv')
# for i in range(train_data['210X24'].shape[0]):
#     if train_data['210X24'][i]==2.01666166617e+13:
#        train_data['210X24'][i]=np.NaN
train_data_date1=train_data[['330X640', '330X641', '330X1165', '330X1168', '330X1169']]
...
df.to_csv('C:/Users/user/Desktop/testA_deal_date/tool_time_delta_4.csv',index=False)
