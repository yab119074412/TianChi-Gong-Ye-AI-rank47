...
train_data=pd.read_csv('C:/Users/user/Desktop/testB_tool_data/TOOL (#3)12.csv')
# for i in range(train_data['210X24'].shape[0]):
#     if train_data['210X24'][i]==2.01666166617e+13:
#        train_data['210X24'][i]=np.NaN
train_data_date1=train_data[[ '750X710', '750X711', '750X1287', '750X1291', '750X1292', '750X1293']]
...
delta_time=pd.DataFrame(delta_time,columns=['time_delta_7'])
df=pd.concat([max_date,min_date,delta_time],axis=1)
df.to_csv('C:/Users/user/Desktop/testA_deal_date/tool_time_delta_7.csv',index=False)
